                ...
                <div key={entry.id} className="flex items-start gap-3 text-sm">
                  ...
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      <Badge variant="outline" className="text-xs">{STATUS_LABELS[entry.oldStatus] || entry.oldStatus}</Badge>
                      <span className="text-muted-foreground">→</span>
                      <Badge variant="secondary" className="text-xs">{STATUS_LABELS[entry.newStatus] || entry.newStatus}</Badge>
                    </div>
